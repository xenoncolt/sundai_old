  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer(){
        let menuoptions = [
          {
            ...
            description: `${client.ad.enabled? "Disables the Ads from Team GalactasX and Coden Heaven" : "Enables the Ads from Team GalactasX and Coden Heaven"}`,
        ...
        .setColor(es.color)
        .setAuthor('Advertising Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/prohibited_1f6ab?.png',  'https://discord.gg/qxNqZ6vfhR')
